...
def main():
  ...
  if args['rec']:
    ...
    for cname in args['<code_name>']:
      ...
      elif result == cgir_12.REC_NO_DATA:
        print('受信失敗. データなし.\n')
      elif result == cgir_12.REC_SHORT:
        print('受信失敗. データ異常.\n')
      elif result == cgir_12.REC_ERR_PIGPIO:
  ...
  if args['dec']:
    ...
    if ir_format == cgir_12.FORMAT_UNKNOWN:
  ...
  if args['enc']:
    ...
    if obj['format'] != cgir_12.FORMAT_AEHA and obj['format'] != cgir_12.FORMAT_NEC and obj[
        'format'] != cgir_12.FORMAT_SONY:
